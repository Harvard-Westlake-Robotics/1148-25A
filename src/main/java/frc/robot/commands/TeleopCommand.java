...
public class TeleopCommand extends Command {
  ...
  private Command reefCommand = AutoBuilder.pathfindThenFollowPath(
      NetworkCommunicator.getInstance().getSelectedReefPath(), TunerConstants.PP_CONSTRAINTS)
      .andThen(
  ...
  private Command sourceCommand = AutoBuilder.pathfindThenFollowPath(
      NetworkCommunicator.getInstance().getSelectedSourcePath(), TunerConstants.PP_CONSTRAINTS)
