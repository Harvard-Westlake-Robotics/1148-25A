...
/**
 * Utility class for managing performance optimization settings and providing
 * system-wide
...
public class PerformanceOptimizer {
    ...
    public static PerformanceStatus getPerformanceStatus() {
        ...
        if (averageLoopTime <= Settings.TARGET_LOOP_TIME_MS * Settings.WARNING_THRESHOLD_PERCENT / 100.0) {
            status = "OPTIMAL";
            recommendation = "Performance is good. All systems operating normally.";
        } else if (averageLoopTime <= Settings.TARGET_LOOP_TIME_MS * Settings.CRITICAL_THRESHOLD_PERCENT / 100.0) {
            status = "WARNING";
    ...
    /**
     * Updates performance optimization settings from SmartDashboard. Allows for
     * real-time tuning of
